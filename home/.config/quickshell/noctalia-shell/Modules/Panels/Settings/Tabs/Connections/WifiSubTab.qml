...
Item {
  ...
  ColumnLayout {
    ...
    NBox {
      ...
      color: showOnlyLists ? Qt.lighter(Color.mSurfaceVariant, 1.51) : "transparent"
    ...
    NBox {
      ...
      ColumnLayout {
        ...
        NBox {
          ...
          color: addHiddenMouseArea.containsMouse ? Qt.lighter(Color.mSurfaceVariant, 1.51) : Color.mSurface
